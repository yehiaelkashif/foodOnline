    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pricuture', models.ImageField(blank=True, null=True, upload_to='users/profile_pictures')),
                ('Cover_photo', models.ImageField(blank=True, null=True, upload_to='users/cover_photos')),
                ('addrees_line_1', models.CharField(blank=True, max_length=50, null=True)),
                ('addrees_line_2', models.CharField(blank=True, max_length=50, null=True)),
